...
```html
<meta name="msapplication-task" content="name=Task 1;action-uri=https://host/Page1.html;icon-uri=http://host/icon1.ico">
<meta name="msapplication-task" content="name=Task 2;action-uri=https://microsoft.com/Page2.html;icon-uri=http://host/icon2.ico">
```
...
[Learn how to make a sitemap](https://www.sitemaps.org/protocol.html)
...
* Use [Microformats](https://microformats.org/wiki/Main_Page) (via
  ...
  results
  [visibility](https://googlewebmastercentral.blogspot.com/2009/05/introducing-rich-snippets.html).
...
for Android Lollipop](https://updates.html5rocks.com/2014/11/Support-for-theme-color-in-Chrome-39-for-Android)
